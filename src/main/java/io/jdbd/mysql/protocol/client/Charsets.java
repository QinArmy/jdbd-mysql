...
public abstract class Charsets {
    ...
    private static List<MyCharset> createMySQLCharsetList() {
        ...
        list.add(new MyCharset("utf8mb3", 3, 1, "UTF-8"));
    ...
    private static List<Collation> createCollationList() {
        ...
        list.add(new Collation(MYSQL_COLLATION_INDEX_utf8, "utf8mb3_general_ci", 1, "utf8mb3"));
        ...
        list.add(new Collation(76, "utf8mb3_tolower_ci", 0, "utf8mb3"));
        ...
        list.add(new Collation(83, "utf8mb3_bin", 0, "utf8mb3"));
        ...
        list.add(new Collation(192, "utf8mb3_unicode_ci", 0, "utf8mb3"));

        list.add(new Collation(193, "utf8mb3_icelandic_ci", 0, "utf8mb3"));
        list.add(new Collation(194, "utf8mb3_latvian_ci", 0, "utf8mb3"));
        list.add(new Collation(195, "utf8mb3_romanian_ci", 0, "utf8mb3"));
        list.add(new Collation(196, "utf8mb3_slovenian_ci", 0, "utf8mb3"));

        list.add(new Collation(197, "utf8mb3_polish_ci", 0, "utf8mb3"));
        list.add(new Collation(198, "utf8mb3_estonian_ci", 0, "utf8mb3"));
        list.add(new Collation(199, "utf8mb3_spanish_ci", 0, "utf8mb3"));
        list.add(new Collation(200, "utf8mb3_swedish_ci", 0, "utf8mb3"));

        list.add(new Collation(201, "utf8mb3_turkish_ci", 0, "utf8mb3"));
        list.add(new Collation(202, "utf8mb3_czech_ci", 0, "utf8mb3"));
        list.add(new Collation(203, "utf8mb3_danish_ci", 0, "utf8mb3"));
        list.add(new Collation(204, "utf8mb3_lithuanian_ci", 0, "utf8mb3"));

        list.add(new Collation(205, "utf8mb3_slovak_ci", 0, "utf8mb3"));
        list.add(new Collation(206, "utf8mb3_spanish2_ci", 0, "utf8mb3"));
        list.add(new Collation(207, "utf8mb3_roman_ci", 0, "utf8mb3"));
        list.add(new Collation(208, "utf8mb3_persian_ci", 0, "utf8mb3"));

        list.add(new Collation(209, "utf8mb3_esperanto_ci", 0, "utf8mb3"));
        list.add(new Collation(210, "utf8mb3_hungarian_ci", 0, "utf8mb3"));
        list.add(new Collation(211, "utf8mb3_sinhala_ci", 0, "utf8mb3"));
        list.add(new Collation(212, "utf8mb3_german2_ci", 0, "utf8mb3"));

        list.add(new Collation(213, "utf8mb3_croatian_ci", 0, "utf8mb3"));
        list.add(new Collation(214, "utf8mb3_unicode_520_ci", 0, "utf8mb3"));
        list.add(new Collation(215, "utf8mb3_vietnamese_ci", 0, "utf8mb3"));
        list.add(new Collation(223, "utf8mb3_general_mysql500_ci", 0, "utf8mb3"));
